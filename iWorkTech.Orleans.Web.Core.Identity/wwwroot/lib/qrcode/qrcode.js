...
<html lang="en">
  ...
  <meta property="fb:app_id" content="1401488693436528">
    ...
    <meta content="https://avatars3.githubusercontent.com/u/3103540?s=400&amp;v=4" property="og:image" /><meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="davidshimjs/qrcodejs" property="og:title" /><meta content="https://github.com/davidshimjs/qrcodejs" property="og:url" /><meta content="qrcodejs - Cross-browser QRCode generator for javascript" property="og:description" />

  <link rel="assets" href="https://assets-cdn.github.com/">
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MjM1NjE0MzQzOmRjNjBmNmY5MTVkY2RhZTUzYjg0MmUyMjA1OTBlNjUxM2ViYmM0YWY3MGUwODhjNTkzNTYxYjFiNGIyODkxYTc=--693ab8661567cb001d6f2239236c0bd810a45952">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="BA2F:0FBC:20729CD:34ACF06:5A58281B" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="BA2F:0FBC:20729CD:34ACF06:5A58281B" name="octolytics-dimension-request_id" /><meta content="iad" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" /><meta content="1383019" name="octolytics-actor-id" /><meta content="ashedge" name="octolytics-actor-login" /><meta content="135471ced3be1dde0aea18c754e63c6ea3e65486c8c9aa5e9556840d32425e97" name="octolytics-actor-hash" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="ashedge">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="">

    <meta name="enabled-features" content="UNIVERSE_BANNER,FREE_TRIALS">

  <meta name="html-safe-nonce" content="dc3af805d0186ea974cbb04636878a8e673ba395">
  ...
  <meta content="3103540" name="octolytics-dimension-user_id" /><meta content="davidshimjs" name="octolytics-dimension-user_login" /><meta content="7323572" name="octolytics-dimension-repository_id" /><meta content="davidshimjs/qrcodejs" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="7323572" name="octolytics-dimension-repository_network_root_id" /><meta content="davidshimjs/qrcodejs" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
...
<header class="Header  f5" role="banner">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/davidshimjs/qrcodejs/search" class="js-site-search-form" data-scoped-search-url="/davidshimjs/qrcodejs/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/davidshimjs/qrcodejs/blob/master/qrcode.js" class="header-search-scope no-underline">This repository</a>
      <input type="text"
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown js-menu-container">
    ...
    <a href="/notifications" aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-channel="notification-changed:1383019" data-ga-click="Header, go to notifications, icon:read" data-hotkey="g n">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown js-menu-container">
    ...
    <details class="dropdown-details details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@ashedge" class="avatar float-left mr-1" src="https://avatars2.githubusercontent.com/u/1383019?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">ashedge</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/ashedge" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/ashedge?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="logout-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Z8PWbewX83p6cahmv7LcuePB92xfDeGLOH8/CMXOCNJD85/eVdvkB2NirUGBPExW0Gz/Erxnmlp4VhhTa2ZtGg==" /></div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/logout" class="sr-only right-0" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="Im/ywLJdXcht6S+EcpXCFyTixO7+2ahaECFYp0yoXwAGX7tzC5FKtXT6KqNMG1L4F0/MkB2z04tQCH/84gA6yA==" /></div>
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/notifications/subscribe" class="js-social-container" data-autosubmit="true" data-remote="true" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="4Tl/RZDImkdcH0BW127IR2VjgGo5ZC8zXKlRKPnvLGe8XBKEysZ7s8iKaxufEHiSPZEHn7qRQ3pGLx6SLuH62g==" /></div>      <input class="form-control" id="repository_id" name="repository_id" type="hidden" value="7323572" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/davidshimjs/qrcodejs/unstar" class="starred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="NRunFDjUPxy63wTFbGZdUT2WL9pKUy1Jo621i0zYSbP0JzdF7FAMcrRHSe/WjIxzeNJJNV2hYr8lLfa+3NOKJA==" /></div>
      ...
      <button
        ...
        <a class="social-count js-social-count" href="/davidshimjs/qrcodejs/stargazers"
           aria-label="4389 users starred this repository">
          4,389
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/davidshimjs/qrcodejs/star" class="unstarred js-social-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="0BNg9j9s00u5cf0PP2v6ZqHcd8+8EhO0jyAweSJEVo+JdUvxKadwvpdv020L5qfHFpzsD7VTiQDL0CfXJZwtkQ==" /></div>
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <span class="author" itemprop="author"><a href="/davidshimjs" class="url fn" rel="author">davidshimjs</a></span><!--
--><span class="path-divider">/</span><!--
--><strong itemprop="name"><a href="/davidshimjs/qrcodejs" data-pjax="#js-repo-pjax-container">qrcodejs</a></strong>
...
<nav class="reponav js-repo-nav js-sidenav-container-pjax container"
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/davidshimjs/qrcodejs" class="js-selected-navigation-item selected reponav-item" data-hotkey="g c" data-selected-links="repo_source repo_downloads repo_commits repo_releases repo_tags repo_branches repo_packages /davidshimjs/qrcodejs" itemprop="url">
    ...
    <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
      <a href="/davidshimjs/qrcodejs/issues" class="js-selected-navigation-item reponav-item" data-hotkey="g i" data-selected-links="repo_issues repo_labels repo_milestones /davidshimjs/qrcodejs/issues" itemprop="url">
  ...
  <span itemscope itemtype="http://schema.org/ListItem" itemprop="itemListElement">
    <a href="/davidshimjs/qrcodejs/pulls" class="js-selected-navigation-item reponav-item" data-hotkey="g p" data-selected-links="repo_pulls /davidshimjs/qrcodejs/pulls" itemprop="url">
    ...
    <a href="/davidshimjs/qrcodejs/projects" class="js-selected-navigation-item reponav-item" data-hotkey="g b" data-selected-links="repo_projects new_repo_project repo_project /davidshimjs/qrcodejs/projects">
      <svg aria-hidden="true" class="octicon octicon-project" height="16" version="1.1" viewBox="0 0 15 16" width="15"><path fill-rule="evenodd" d="M10 12h3V2h-3v10zm-4-2h3V2H6v8zm-4 4h3V2H2v12zm-1 1h13V1H1v14zM14 0H1a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h13a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1z"/></svg>
      Projects
      <span class="Counter" >0</span>
</a>
    <a href="/davidshimjs/qrcodejs/wiki" class="js-selected-navigation-item reponav-item" data-hotkey="g w" data-selected-links="repo_wiki /davidshimjs/qrcodejs/wiki">
      <svg aria-hidden="true" class="octicon octicon-book" height="16" version="1.1" viewBox="0 0 16 16" width="16"><path fill-rule="evenodd" d="M3 5h4v1H3V5zm0 3h4V7H3v1zm0 2h4V9H3v1zm11-5h-4v1h4V5zm0 2h-4v1h4V7zm0 2h-4v1h4V9zm2-6v9c0 .55-.45 1-1 1H9.5l-1 1-1-1H2c-.55 0-1-.45-1-1V3c0-.55.45-1 1-1h5.5l1 1 1-1H15c.55 0 1 .45 1 1zm-8 .5L7.5 3H2v9h6V3.5zm7-.5H9.5l-.5.5V12h6V3z"/></svg>
      Wiki
</a>

  <a href="/davidshimjs/qrcodejs/pulse" class="js-selected-navigation-item reponav-item" data-selected-links="repo_graphs repo_contributors dependency_graph pulse /davidshimjs/qrcodejs/pulse">
...
<div class="container new-discussion-timeline experiment-repo-nav ">
  ...
  <a href="/davidshimjs/qrcodejs/blob/04f46c6a0708418cb7b96fc563eacae0fbf77674/qrcode.js" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:d9ab08be8abf0fa547db750d85fd5b97 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
    ...
    <div class="breadcrumb js-zeroclipboard-target">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a href="/davidshimjs/qrcodejs"><span>qrcodejs</span></a></span></span><span class="separator">/</span><strong class="final-path">qrcode.js</strong>
    </div>
  </div>
  ...
  <div class="commit-tease">
      ...
      <div>
        <img alt="@ysangkok" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/284023?v=4&amp;s=40" width="20" />
      ...
      <button type="button" class="btn-link muted-link contributors-toggle" data-facebox="#blob_contributors_box">
        <strong>7</strong>
         contributors
          ...
          <a class="avatar-link tooltipped tooltipped-s" aria-label="davidshimjs" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=davidshimjs"><img alt="@davidshimjs" class="avatar" height="20" src="https://avatars1.githubusercontent.com/u/3103540?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="davidcl64" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=davidcl64"><img alt="@davidcl64" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/928988?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="ysangkok" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=ysangkok"><img alt="@ysangkok" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/284023?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="sembrestels" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=sembrestels"><img alt="@sembrestels" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/931684?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="taku0" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=taku0"><img alt="@taku0" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/870673?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="ghigo" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=ghigo"><img alt="@ghigo" class="avatar" height="20" src="https://avatars0.githubusercontent.com/u/185571?v=4&amp;s=40" width="20" /> </a>
    <a class="avatar-link tooltipped tooltipped-s" aria-label="lukem512" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=lukem512"><img alt="@lukem512" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/2834976?v=4&amp;s=40" width="20" /> </a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <img alt="@davidshimjs" height="24" src="https://avatars3.githubusercontent.com/u/3103540?v=4&amp;s=48" width="24" />
            <a href="/davidshimjs">davidshimjs</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@davidcl64" height="24" src="https://avatars1.githubusercontent.com/u/928988?v=4&amp;s=48" width="24" />
            <a href="/davidcl64">davidcl64</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@ysangkok" height="24" src="https://avatars1.githubusercontent.com/u/284023?v=4&amp;s=48" width="24" />
            <a href="/ysangkok">ysangkok</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@sembrestels" height="24" src="https://avatars0.githubusercontent.com/u/931684?v=4&amp;s=48" width="24" />
            <a href="/sembrestels">sembrestels</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@taku0" height="24" src="https://avatars1.githubusercontent.com/u/870673?v=4&amp;s=48" width="24" />
            <a href="/taku0">taku0</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@ghigo" height="24" src="https://avatars2.githubusercontent.com/u/185571?v=4&amp;s=48" width="24" />
            <a href="/ghigo">ghigo</a>
          </li>
          <li class="facebox-user-list-item">
            <img alt="@lukem512" height="24" src="https://avatars1.githubusercontent.com/u/2834976?v=4&amp;s=48" width="24" />
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/davidshimjs/qrcodejs/raw/master/qrcode.js" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/davidshimjs/qrcodejs/blame/master/qrcode.js" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/davidshimjs/qrcodejs/commits/master/qrcode.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/davidshimjs/qrcodejs/edit/master/qrcode.js" class="inline-form js-update-url-with-hash" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="mCXST/hkZo+jlMj2YAY7ewFp/jM3vpLiB6p2LEZ+EwIk2oISFT0uZY1UUoamAp3Qsg2sCmkj55/UVfIkgZegmg==" /></div>
          <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
            aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
            <svg aria-hidden="true" class="octicon octicon-pencil" height="16" version="1.1" viewBox="0 0 14 16" width="14"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
          </button>
</form>        <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/davidshimjs/qrcodejs/delete/master/qrcode.js" class="inline-form" method="post"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /><input name="authenticity_token" type="hidden" value="GnsTgjrJx7K2r7wC0WGC+j9SfBnEyJjDsfM2tlSuOO7YxbV8KHCohEd4sh9JoYo32rEIgkdKRqD7NCgT2xOtwg==" /></div>
  ...
  <div class="BlobToolbar position-absolute js-file-line-actions dropdown js-menu-container js-select-menu d-none" aria-hidden="true">
    ...
    <div class="dropdown-menu-content js-menu-content" id="inline-file-actions">
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a href="/davidshimjs/qrcodejs/blame/04f46c6a0708418cb7b96fc563eacae0fbf77674/qrcode.js" class="dropdown-item js-update-url-with-hash" id="js-view-git-blame">View git blame</a></li>
          <li><a href="/davidshimjs/qrcodejs/issues/new" class="dropdown-item" id="js-new-issue">Open new issue</a></li>
      </ul>
    </div>
  </div>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between py-6 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.19777s from unicorn-3927568667-ftr18">GitHub</span>, Inc.</li>
